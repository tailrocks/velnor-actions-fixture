# GitHub Actions runner policy (relocated)

Relocated from hand-maintained `.github/AGENTS.md` during the schema-2 wave regen (R14): `.github` is fully generator-owned, so hand content lives here. The generator now owns `.github/AGENTS.md` (+ `.github/CLAUDE.md` symlink).
...
- Everything under `.github` is generated by `velnor-workflow` (the workflow
  ...
  hand-edit generated files in this directory: change the generator or this
  repository's generation configuration and regenerate. AGENTS.md files are
  the only hand-maintained files under `.github`.
