...
Current source inventory captured from Velnor **fbc1f76612739652428a75dd8b6a96e0713a45c2**. The JSON
...
- Velnor source: [`fbc1f76612739652428a75dd8b6a96e0713a45c2`](https://github.com/tailrocks/velnor/tree/fbc1f76612739652428a75dd8b6a96e0713a45c2).
...
| `.github/workflows/ci-policy.yml` | `2d2d1131961f89f87f872f090c4e2f759cc87f6bcd4cd057f6ba0a63a22fa0d7` | `ci.yml` | `tailrocks/velnor/.github/workflows/velnor-workflow-policy.yml` |
...
| `.github/workflows/nightly.yml` | `157ac0e3f1d1b4685e05cf15a20dd5267a56a71e3dd726d9ee25f4c9dcd2a073` | `schedule.yml` | `actions/checkout`, `actions/upload-artifact`, `local:./.github/workflows/ci-bun-velnor.yml`, `local:./.github/workflows/ci-docker-docker.yml`, `local:./.github/workflows/ci-docs-docs.yml`, `local:./.github/workflows/ci-opentofu-opentofu.yml`, `local:./.github/workflows/ci-rust-policy.yml`, `local:./.github/workflows/ci-rust-unit-collector.yml`, `local:./.github/workflows/ci-rust-velnor-bench.yml`, `local:./.github/workflows/ci-rust-velnor-client.yml`, `local:./.github/workflows/ci-rust-velnor-control.yml`, `local:./.github/workflows/ci-rust-velnor-model.yml`, `local:./.github/workflows/ci-rust-velnor-render.yml`, `local:./.github/workflows/ci-rust-velnor-runner.yml`, `local:./.github/workflows/ci-rust-velnor-tools.yml`, `local:./.github/workflows/ci-rust-velnor-workflow.yml`, `local:./.github/workflows/ci-rust-velnorctl.yml`, `tailrocks/velnor/.github/actions/setup-velnor-workflow`, `tailrocks/velnor/.github/workflows/velnor-workflow-policy.yml` |
